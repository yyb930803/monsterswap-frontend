...
const StakeModal: React.FC<StakeModalProps> = ({
  ...
  console.log("onStake", sousId, isBnbPool)
  ...
  const handleConfirmClick = async () => {
    ...
    if (isRemovingStake) {
      ...
      try {
        console.log("onStake111", stakeAmount, stakingToken.decimals)
        // staking
  ...
  return (
    ...
    >
      ...
      <ButtonWrapper>
        <Button variant="secondary" className="secondary" onClick={() => { onDismiss() }}>
          {t('Cancel')}
        </Button>
        <Button
          className="primary"
