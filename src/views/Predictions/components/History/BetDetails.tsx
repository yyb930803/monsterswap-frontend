  ...
  return (
    <StyledBetDetails>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <a href={getBscScanLink(bet.round.lockBlock, 'block')} target="_blank" rel="noreferrer">
          {bet.round.lockBlock}
        </a>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text>{t('Closing Block')}</Text>
        <a href={getBscScanLink(bet.round.endBlock, 'block')} target="_blank" rel="noreferrer">
          {bet.round.endBlock}
        </a>
      </Flex>
    </StyledBetDetails>
