...
import { Flex, Text, Tag, CheckmarkCircleIcon } from 'uikit'
    ...
    <Row>
      <AddressColumn>
        <Flex alignItems="center">
          <a href={getBscScanLink(vote.voter, 'address')}>{truncateWalletAddress(vote.voter)}</a>
          {isVoter && (
      ...
      <VotingPowerColumn>
        <Flex alignItems="center" justifyContent="end">
          ...
          {/* {hasVotingPower && <a href={`${IPFS_GATEWAY}/${vote.id}`} />} */}
        </Flex>
      </VotingPowerColumn>
    </Row>
  )
